...
def processParkingHandler(parking):
    ...
    try:
        ...
        rental_URL = f"http://localhost:5001/rental/endtrip/{parking['rentalid']}/{parking_spot_id}"
    ...
    try:
        ...
        vehicle_URL = "http://localhost:5003/rentalvehicle/updateavailable/" + rental_return['data']['PlateNo']
        json_to_send ={
